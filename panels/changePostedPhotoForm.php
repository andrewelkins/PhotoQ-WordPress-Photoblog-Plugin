<div id="PhotoQ_Photo_PhotoBox" class="postbox">
	<h3 class='hndle'><span><?php _e('PhotoQ Photo', 'PhotoQ'); ?></span></h3>
	<div class="inside">
		<p>
		<?php 
			echo $photo->getAdminThumbImgTag(
				new PhotoQ_Photo_Dimension(
					$oc->getValue('editPostThumbs-Width'),
					$oc->getValue('editPostThumbs-Height')
				)
			); 
		?>
		</p>
...
/* <![CDATA[ */
		...
		function enhanceForm() {
			...
			jQuery('#PhotoQ_Photo_PhotoBox').insertAfter('#titlediv');
