...
<form id="photoQForm" method="post" action="<?php $manageMenu = new PhotoQ_Util_ManageAdminMenuLocation(); echo $manageMenu->getPageName(); ?>">
...
<?php if($qLength): ?>
	...
	<ul id="photoq">
		...
		for ($i = 0; $i < $qLength; $i++){
			...
			$deleteLink = $manageMenu->getPageName() . '&action=delete&id='.$currentPhoto->getId();
